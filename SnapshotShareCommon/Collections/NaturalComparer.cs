...
namespace Snapshot.Share.Common.Collections {
  /// <summary>
  /// コレクションを自然順でソートします
  /// </summary>
  /// <example>
  ...
  /// </example>
  /// <see cref="https://github.com/tomochan154/toy-box/blob/master/NaturalComparer.cs"></see>
  ...
  public class NaturalComparer : IComparer<string>, IComparer {
    ...
    public NaturalComparer () : this (NaturalSortOrder.Ascending, NaturalComparerOptions.Default, new char[0]) { }

    /// <summary>インスタンスを初期化します。</summary>
    /// <param name="order">ソート方向を表す <see cref="NaturalSortOrder"/>。</param>
    public NaturalComparer (NaturalSortOrder order) : this (order, NaturalComparerOptions.Default, new char[0]) { }

    /// <summary>インスタンスを初期化します。</summary>
    /// <param name="order">ソート方向を表す <see cref="NaturalSortOrder"/>。</param>
    /// <param name="options">比較方法を表す <see cref="NaturalComparerOptions"/>。</param>
    public NaturalComparer (NaturalSortOrder order, NaturalComparerOptions options) : this (order, NaturalComparerOptions.Default, new char[0]) { }
